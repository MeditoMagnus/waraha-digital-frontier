...
const AboutUsExtended: React.FC = () => {
  ...
  return (
    <section id="about-extended" ref={sectionRef} className="section bg-waraha-midnight py-20">
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-serif mb-6">Our Vision & Mission</h2>
            
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="mt-1 h-10 w-10 bg-waraha-gold/20 rounded-full flex items-center justify-center flex-shrink-0">
                  <Medal className="h-5 w-5 text-waraha-gold" />
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">Excellence in Every Service</h3>
          ...
          >
            <h2 className="text-3xl md:text-4xl font-serif mb-6">Why Waraha Group?</h2>
            
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="mt-1 h-10 w-10 bg-waraha-silver/20 rounded-full flex items-center justify-center flex-shrink-0">
                  <Globe className="h-5 w-5 text-waraha-silver" />
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">UAE Market Expertise</h3>
                  <p className="text-gray-300">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">Integrated Service Approach</h3>
                  <p className="text-gray-300">
        ...
        <div 
          className="mt-16 p-8 glassmorphism rounded-lg text-center"
          style={{ 
            opacity: isInView ? 1 : 0,
        ...
        >
          <h3 className="text-2xl font-serif mb-4">Our UAE Presence</h3>
