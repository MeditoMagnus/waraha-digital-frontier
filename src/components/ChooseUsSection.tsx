...
const ChooseUsSection: React.FC = () => {
  ...
  return (
    <section id="why-us" ref={sectionRef} className="why-us-section py-20">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20 transition-opacity duration-1000">
          {benefits.map((benefit, index) => (
            <div 
              key={benefit.title} 
              className="why-us-card p-6 rounded-lg text-center"
              style={{ 
            ...
            >
              ...
              <h3 className="text-xl font-semibold why-us-card-title mb-2">{benefit.title}</h3>
              <p className="why-us-card-description">{benefit.description}</p>
            </div>
          ))}
        </div>
      </div>
