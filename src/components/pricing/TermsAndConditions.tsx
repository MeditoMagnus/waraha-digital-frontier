...
const TermsAndConditions: React.FC = () => {
  return (
    <section className="section bg-gradient-to-b from-slate-700/95 to-slate-800/95 backdrop-blur-sm dark:from-slate-700/95 dark:to-slate-800/95 light:from-pure-white-exact light:to-off-white-exact">
      <div className="container mx-auto">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-2xl font-serif mb-6 text-yellow-400 text-center dark:text-yellow-400 light:text-waraha-gold-exact">Terms & Conditions</h3>
          <Card className="bg-slate-800/80 backdrop-blur-md border-slate-600/50 shadow-2xl dark:bg-slate-800/80 dark:border-slate-600/50 light:bg-pure-white-exact light:border-muted-gray-exact">
            <CardContent className="p-6">
              <ul className="space-y-4 text-slate-200 dark:text-slate-200 light:text-charcoal-black-exact">
                <li className="flex items-start gap-3">
                  <span className="text-yellow-400 mt-1 text-lg dark:text-yellow-400 light:text-waraha-gold-exact">•</span>
