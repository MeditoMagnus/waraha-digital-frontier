...
const BusinessAdvisory: React.FC = () => {
  const subServices = [
    'Business Setup & Structuring (Mainland, Free Zone, Offshore)',
  ...
  return (
    <div className="min-h-screen w-full">
      <SEOMetaTags 
        title="Business Advisory Services - Waraha Group UAE"
        description="Strategic business advisory services in UAE including business setup, market entry strategy, and M&A advisory."
        keywords={['UAE business advisory', 'business setup Dubai', 'market entry strategy', 'M&A advisory']}
      />
      <ParticleBackground />
      <Navbar />
        ...
        <div className="container mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Strategic business consulting to optimize performance, manage risks, and achieve sustainable 
              growth in the competitive UAE market with expert advisory services.
            </p>
          </div>

          <div className="glassmorphism rounded-lg p-8 mb-12">
            <h2 className="text-2xl font-semibold mb-6 text-white">Our Business Advisory Sub-Services</h2>
